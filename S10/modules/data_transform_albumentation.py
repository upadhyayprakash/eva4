...
from albumentations import (
    Cutout, RandomGamma, ElasticTransform, IAAPerspective, HueSaturationValue,
...
def strong_aug(p=1.0):
    return Compose([
        Cutout(num_holes=1, max_h_size=16, max_w_size=16, fill_value=[0.4914*255, 0.4822*255, 0.4465*255], p=1.),
        HorizontalFlip(p=0.5),
        # RandomGamma(p=0.5),
